...
Route::get('/shiprocket/token', [ShiprocketController::class, 'getToken']);
// Route::get('/shiprocket/create-order', [ShiprocketController::class, 'createOrder']);
Route::get('/orders/{id}/create-shipment', [ShiprocketController::class, 'createOrder'])
