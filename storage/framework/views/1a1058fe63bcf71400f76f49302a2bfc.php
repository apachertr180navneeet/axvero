        ...
        <div class="container text-center">
            <div class="row">
                <div class="col-lg-6 text-center text-lg-left">
                    <h1 class="fw-700 fs-20 fs-md-24 text-dark"><?php echo e(translate('Track Order')); ?></h1>
                </div>
                <div class="col-lg-6">
                        ...
                        <div class="bg-white border rounded-0">
                            ...
                            <div class="form-box-content p-3">
                                <div class="form-group">
                                    <input type="text" class="form-control rounded-0 mb-3" placeholder="<?php echo e(translate('Order Code')); ?>" name="order_code" required>
                                </div>
                                <div class="text-right">
                                    <button type="submit" class="btn btn-primary rounded-0 w-150px"><?php echo e(translate('Track Order')); ?></button>
                                </div>
                            </div>
                        </div>
                    </form>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u536896586/domains/axvero.in/public_html/resources/views/frontend/track_order.blade.php ENDPATH**/ ?>