...
<a href="javascript:void(0)" class="d-flex align-items-center <?php if(get_setting('header_element') !=6): ?> px-3 <?php endif; ?> h-100" data-toggle="dropdown" data-display="static"
    ...
    <?php if(get_setting('header_element') != 6): ?>
        <span class="mr-2"  onclick="event.stopPropagation(); window.location.href='<?php echo e(route('checkout')); ?>';">
...
<div class="dropdown-menu dropdown-menu-right dropdown-menu-lg p-0 stop-propagation rounded-0">
    ...
    <?php endif; ?>
</div><?php /**PATH /home/u536896586/domains/axvero.in/public_html/resources/views/frontend/partials/cart/cart.blade.php ENDPATH**/ ?>