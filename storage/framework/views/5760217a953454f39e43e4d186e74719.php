                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['add_new_product', 'show_all_products','show_in_house_products','show_seller_products','add_digital_product','edit_digital_product','product_bulk_import',
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <?php endif; ?>
                             <li class="aiz-side-nav-item">
                                    <a href="<?php echo e(route('product_limit.create')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['detail-reviews', 'custom-review.edit'])); ?>">
                                        <span class="aiz-side-nav-text"><?php echo e(translate('Product Limit')); ?></span>
                                    </a>
                                </li>
                        </ul>
                    </li>
 ...
 <!-- Refund addon -->
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <?php endif; ?>
                        <li class="aiz-side-nav-item">
    <a href="<?php echo e(route('join-agent')); ?>" class="aiz-side-nav-link">
        <span class="aiz-side-nav-text">Members List</span>
    </a>
</li>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage_bulk_buyers')): ?>
                        <li class="aiz-side-nav-item">
                            <a href="<?php echo e(route('bulk_buyers.index')); ?>"
                                class="aiz-side-nav-link <?php echo e(areActiveRoutes(['bulk_buyers.index', 'bulk_buyers.show', 'bulk_buyers.customers'])); ?>">
                                <span class="aiz-side-nav-text"><?php echo e(translate('Bulk Buyers')); ?></span>
                            </a>
                        </li>
                        <?php endif; ?>
                        ...
                        <li class="aiz-side-nav-item">
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage_shipping_system')): ?>
                                    <li class="aiz-side-nav-item">
                                        <a href="<?php echo e(route('shipping_system')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['shipping_system'])); ?>">
                                            <span class="aiz-side-nav-text"><?php echo e(translate('Shippping Configuration')); ?></span>
                                        </a>
                                    </li>
                                <?php endif; ?>
                            </ul>
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('select_font_family')): ?>
                                <li class="aiz-side-nav-item">
                                    <a href="<?php echo e(route('website.select-font-family')); ?>" class="aiz-side-nav-link">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('select_header')): ?>
                                <li class="aiz-side-nav-item">
                                    <a href="<?php echo e(route('website.select-header')); ?>" class="aiz-side-nav-link">
                                ...
                                <li class="aiz-side-nav-item">
                                    ...
                                    <ul class="aiz-side-nav-list level-3">
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_top_banner')): ?>
                                            <li class="aiz-side-nav-item">
                                                <a class="aiz-side-nav-link <?php echo e(areActiveRoutes(['top_banner.create', 'top_banner.edit'])); ?>" href="<?php echo e(route('top_banner.index')); ?>">
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('top_banner_setting')): ?>
                                            <li class="aiz-side-nav-item">
                                                <a class="aiz-side-nav-link" href="<?php echo e(route('top_banner.setting')); ?>">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('footer_setup')): ?>
                                <li class="aiz-side-nav-item">
                                    <a href="<?php echo e(route('website.footer', ['lang' => App::getLocale()])); ?>" class="aiz-side-nav-link">
...
</div><!-- .aiz-sidebar --><?php /**PATH /home/u536896586/domains/axvero.in/public_html/resources/views/backend/inc/admin_sidenav.blade.php ENDPATH**/ ?>