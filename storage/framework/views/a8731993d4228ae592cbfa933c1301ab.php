                                ...
                                <?php $__currentLoopData = get_all_active_language(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li>
                                        <a href="javascript:void(0)" data-flag="<?php echo e($language->code); ?>"
                                            class="dropdown-item <?php if($system_language->code == $language->code): ?> active <?php endif; ?> text-dark"
                                           >
                        ...
                        <li class="list-inline-item dropdown ml-auto ml-lg-0 mr-0 currency-visibility" id="currency-change">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right dropdown-menu-lg-left">
                                <?php $__currentLoopData = get_all_active_currency(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li>
                                        <a class="dropdown-item text-dark <?php if($system_currency->code == $currency->code): ?> active <?php endif; ?>"
                        ...
                        <li class="list-inline-item d-flex">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu fs-12 p-0 mt-1">
                                    <a class="dropdown-item py-2 px-2 text-dark" href="<?php echo e(route('seller.login')); ?>">
...
<header
    class="<?php if(get_setting('header_stikcy') == 'on'): ?> sticky-top <?php endif; ?> z-1020 violet-cart middle-background-color-visibility stikcy-header-visibility"
        ...
        <div class="container">
           <div class="d-flex align-items-center flex-nowrap">
                ...
                <div class="col-auto pl-0 pr-1 pr-md-3 d-flex align-items-center">
                    <a class="d-block py-20px mr-2 mr-md-3 ml-0 d-flex align-items-center" href="<?php echo e(route('home')); ?>">
                        <?php
                        ...
                        <?php else: ?>
                            <img id="header-logo-preview" src="<?php echo e(static_asset('assets/img/logo.png')); ?>" alt="<?php echo e(env('APP_NAME')); ?>"
                                class="mw-100 h-80px h-md-80px" height="80">
                        <?php endif; ?>
                        <span class="ml-2 fs-16 fw-700" style="color: <?php echo e($middleHeaderTextColor); ?>"><?php echo e(env('APP_NAME')); ?></span>
                    </a>
                </div>
                        ...
                        <span class="d-flex align-items-center nav-user-info py-20px <?php if(isAdmin()): ?> ml-5 <?php endif; ?>"
                            ...
                            <span class="size-20px size-lg-40px  rounded-circle overflow-hidden border border-transparent nav-user-img">
                                <?php if($user->avatar_original != null): ?>
                                    <img src="<?php echo e(uploaded_asset(Auth::user()->avatar_original)); ?>" class="img-fit h-100 mb-2" alt="<?php echo e(translate('avatar')); ?> "
                                        onerror="this.onerror=null;this.src='<?php echo e(static_asset('assets/img/avatar-place.png')); ?>';">
                                <?php else: ?>
                                    <img src="<?php echo e(static_asset('assets/img/avatar-place.png')); ?>" class="image mb-2"
                                        alt="<?php echo e(translate('avatar')); ?>"
                                        onerror="this.onerror=null;this.src='<?php echo e(static_asset('assets/img/avatar-place.png')); ?>';">
                                <?php endif; ?>
                            </span>
                            <!-- Name -->
                            <h4 class="h5 fs-14 fw-700 ml-2 mb-0 middle-text-color-visibility d-none d-lg-block" style="color: <?php echo e($middleHeaderTextColor); ?>"><?php echo e($user->name); ?></h4>
                        </span>
                    <?php else: ?>
                        <!--Login & Registration -->
                        <span class="d-flex align-items-center nav-user-info ml-3">
                            ...
                            <a href="<?php echo e(route('user.login')); ?>" style="color: <?php echo e($middleHeaderTextColor); ?>"
                                class="middle-text-color-visibility opacity-60 hov-opacity-100 hov-text-primary fs-12 d-inline-block border-right border-soft-light border-width-2 pr-2 ml-3"><?php echo e(translate('Login')); ?></a>
                            <a href="<?php echo e(route('user.registration')); ?>" style="color: <?php echo e($middleHeaderTextColor); ?>"
                                
                                class="middle-text-color-visibility opacity-60 hov-opacity-100 hov-text-primary fs-12 d-inline-block py-2 pl-2"><?php echo e(translate('Registration')); ?></a>
                        </span>
                    <?php endif; ?>
                </div>
            </div>
                ...
                <div class="position-static float-right">
                    <div class="aiz-user-top-menu bg-white rounded-0 border-top shadow-sm" style="width:220px;">
                        ...
                        <li class="user-top-nav-element border border-top-0">
                            ...
                            <a href="https://wa.me/?text=<?php echo e($whatsappText); ?>"
                               target="_blank"
                               class="text-truncate text-dark px-4 fs-14 d-flex align-items-center hov-column-gap-1">
    ...
    <?php if(isCustomer()): ?>
        <li class="user-top-nav-element border border-top-0">
            <a href="<?php echo e(route('agent.join')); ?>"
               class="text-truncate text-dark px-4 fs-14 d-flex align-items-center hov-column-gap-1">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#b5b5bf" viewBox="0 0 24 24">
...
<?php endif; ?>
    ...
    <!-- Menu Bar -->
    <div class="d-none d-lg-block position-relative h-50px border-bottom bottom-background-color-visibility" style="background-color: <?php echo e(get_setting('bottom_header_bg_color')); ?>">
                            ...
                            <ul class="list-inline mb-0 pl-0 hor-swipe c-scrollbar-light">
                                <?php if(get_setting('header_menu_labels') != null): ?>
                                    <?php $__currentLoopData = json_decode(get_setting('header_menu_labels'), true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <?php if($value == 'Membership Retainer' && !auth()->check()): ?>
                                            <?php continue; ?>
                                        <?php endif; ?>
                                        ...
                                        <li class="list-inline-item mr-0 animate-underline-white">
                                            <a href="<?php echo e(json_decode(get_setting('header_menu_links'), true)[$key]); ?>"
                                               ...
                                               style="color: <?php echo e($bottomHeaderTextColor); ?>">
                                                <?php echo e(translate($value)); ?>
...
</header><?php /**PATH C:\xampp\htdocs\axvero\ecom\resources\views/header/header4.blade.php ENDPATH**/ ?>