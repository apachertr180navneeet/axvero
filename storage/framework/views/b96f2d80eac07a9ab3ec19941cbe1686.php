<div class="text-left">
    ...
    <?php if($detailedProduct->brand != null): ?>
        <div class="d-flex flex-wrap align-items-center mb-3">
            <span class="text-secondary fs-13 fw-400 mr-4 w-80px"><?php echo e(translate('Brand')); ?></span><br>
            <a href="<?php echo e(route('products.brand', $detailedProduct->brand->slug)); ?>"
                class="text-reset hov-text-primary fs-13 fw-700"><?php echo e($detailedProduct->brand->name); ?></a>
        </div>
    <?php endif; ?>
    <!-- Product Name -->
    ...
    <div class="row align-items-center mb-3">
        ...
        <?php if($detailedProduct->auction_product != 1): ?>
            <div class="col-12">
                ...
                <span class="ml-1 opacity-50 fs-13">(<?php echo e($total); ?>
        ...
        <?php if($detailedProduct->est_shipping_days): ?>
            <div class="col-auto fs-13 mt-1">
                <small class="mr-1 opacity-50 fs-13"><?php echo e(translate('Estimate Shipping Time')); ?>:</small>
    ...
    <?php if($detailedProduct->has_warranty == 1 && $detailedProduct->warranty_id != null): ?>
        <div class="d-flex flex-wrap align-items-center mb-3">
            <span class="text-secondary fs-13 fw-400 mr-4 w-80px"><?php echo e(translate('Warranty')); ?></span><br>
    ...
    <div class="d-flex flex-wrap align-items-center">
        <div class="d-flex align-items-center mr-4">
            ...
            <?php if($detailedProduct->added_by == 'seller' && get_setting('vendor_system_activation') == 1): ?>
                <span class="text-secondary fs-13 fw-400 mr-4 w-80px"><?php echo e(translate('Sold by')); ?></span>
                <a href="<?php echo e(route('shop.visit', $detailedProduct->user->shop->slug)); ?>"
                    class="text-reset hov-text-primary fs-13 fw-700"><?php echo e($detailedProduct->user->shop->name); ?></a>
            <?php else: ?>
                <p class="mb-0 fs-13 fw-700"><?php echo e(translate('Inhouse product')); ?></p>
            <?php endif; ?>
        </div>
         ...
         <?php if(get_setting('whatsapp_order') == 1): ?>
            ...
            <div class="ml-2">
                <a class="btn btn-sm btn-soft-whatsapp-base hov-svg-white hov-text-white rounded-4"
                    href="<?php echo e($whatsappUrl); ?>" target="_blank">
                    <i class="lab la-whatsapp mr-1"></i><?php echo e(translate('Order Via WhatsApp')); ?>
    ...
    <div id="live-product-viewing-visitors" class="live-product-viewing-visitors d-flex align-items-center mb-3 pt-2">
        ...
        <div class="text"><span class="count fw-700"></span> <?php echo e(translate('people are viewing this item right now')); ?></div>
    </div>
    <?php endif; ?>
    ...
    <?php if($detailedProduct->auction_product): ?>
        <div class="row no-gutters mb-3">
            <div class="col-sm-2">
                <div class="text-secondary fs-13 fw-400 mt-1"><?php echo e(translate('Auction Will End')); ?></div>
            </div>
            <div class="col-sm-10">
        ...
        <div class="row no-gutters mb-3">
            <div class="col-sm-2">
                <div class="text-secondary fs-13 fw-400 mt-1"><?php echo e(translate('Starting Bid')); ?></div>
            </div>
            <div class="col-sm-10">
        ...
        <?php if(Auth::check() &&
            ...
            <div class="row no-gutters mb-3">
                <div class="col-sm-2">
                    <div class="text-secondary fs-13 fw-400 mt-1"><?php echo e(translate('My Bidded Amount')); ?></div>
                </div>
                <div class="col-sm-10">
                    <span class="opacity-50 fs-20">
        ...
        <div class="row no-gutters my-2 mb-3">
            <div class="col-sm-2">
                <div class="text-secondary fs-13 fw-400 mt-1"><?php echo e(translate('Highest Bid')); ?></div>
            </div>
            <div class="col-sm-10">
    ...
    <?php else: ?>
        ...
        <?php else: ?>
            ...
            <?php if(home_price($detailedProduct) != home_discounted_price($detailedProduct)): ?>
                <div class="row no-gutters mb-3">
                    <div class="col-sm-2">
                        <div class="text-secondary fs-13 fw-400"><?php echo e(translate('Price')); ?></div>
                    </div>
                    <div class="col-sm-10">
        ...
        <form id="option-choice-form" class="product-details-page">
            ...
            <?php if($detailedProduct->digital == 0): ?>
                ...
                <?php if($detailedProduct->colors != null && count(json_decode($detailedProduct->colors)) > 0): ?>
                    <div class="row no-gutters mb-3">
                        <div class="col-sm-2">
                            <div class="text-secondary fs-13 fw-400 mt-2"><?php echo e(translate('Color')); ?></div>
                        </div>
                        <div class="col-sm-10">
                            <div class="aiz-radio-inline">
                ...
                <div class="row no-gutters pb-3 d-none" id="chosen_price_div">
                    <div class="col-sm-2">
                        <div class="text-secondary fs-13 fw-400 mt-1"><?php echo e(translate('Total Price')); ?></div>
                    </div>
                    <div class="col-sm-10">
               ...
               <div class="row no-gutters mb-3">
                    <div class="col-sm-5 d-flex">
                        <div class="fs-13 fw-400 text-secondary"><?php echo e(translate('Quantity')); ?></div>
                        <?php
                            $qty = 0;
                 ...
                 <!-- Add to cart & Buy now Buttons -->
                    <div class="col-sm-9">
                        <div class="product-quantity d-flex align-items-center">
                            ...
                            <a type="button" class="btn bg-soft-primary add-to-cart fw-600 min-w-150px w-100 rounded-1 text-primary hov-bg-primary hov-text-light px-4 " href="<?php echo e($detailedProduct->external_link); ?>">
                                <i class="la la-share"></i> <?php echo e(translate($detailedProduct->external_link_btn)); ?>

                            </a>
                            <?php else: ?>
                            <button type="button" class="btn bg-soft-primary add-to-cart fw-600 min-w-150px w-75 rounded-1  text-primary hov-bg-primary hov-text-light" <?php if(Auth::check() || get_Setting('guest_checkout_activation')==1): ?> onclick="addToCart()" <?php else: ?> onclick="showLoginModal()" <?php endif; ?>>
                ...
                <div class="row no-gutters">
                    <div class="col-sm-9">
                        <div class="product-quantity d-flex align-items-center">
                            <?php if(((get_setting('product_external_link_for_seller') == 1) && ($detailedProduct->added_by == "seller") && ($detailedProduct->external_link != null)) || (($detailedProduct->added_by != "seller") && ($detailedProduct->external_link != null))): ?>
                            <?php else: ?>
                            <button type="button" class="btn btn-dark buy-now fw-600 add-to-cart min-w-150px rounded-1 w-100" <?php if(Auth::check() || get_Setting('guest_checkout_activation')==1): ?> onclick="buyNow()" <?php else: ?> onclick="showLoginModal()" <?php endif; ?>>
                ...
                <div class="row no-gutters mb-3">
                    <div class="col-sm-9">
                        <button type="button" class="btn btn-dark buy-now fw-600 add-to-cart min-w-150px rounded-1 w-100"
                            <?php if(Auth::check() || get_Setting('guest_checkout_activation')==1): ?> onclick="buyNow()" <?php else: ?> onclick="showLoginModal()" <?php endif; ?>>
    ...
    <?php else: ?>
        ...
        <?php if(addon_is_activated('refund_request')): ?>
            <div class="row no-gutters mt-3">
                <div class="col-sm-2">
                    <div class="text-secondary fs-13 fw-400 mt-2"><?php echo e(translate('Refund')); ?></div>
                </div>
                <div class="col-sm-10">
                    <?php if($detailedProduct->refundable == 1): ?>
                        ...
                        <a href="<?php echo e(route('returnpolicy')); ?>" class="text-blue hov-text-primary fs-13 ml-3" target="_blank"><?php echo e(translate('View Policy')); ?></a>
                        
                    <?php else: ?>
                        <div class="text-dark fs-13 fw-400 mt-2"><?php echo e(translate('Not Applicable')); ?></div>
                    <?php endif; ?>
                </div>
            </div>
        <?php endif; ?>
        ...
        <?php if($detailedProduct->digital == 1): ?>
            <?php if($detailedProduct->added_by == 'seller'): ?>
                <div class="row no-gutters mt-3">
                    <div class="col-2">
                        <div class="text-secondary fs-13 fw-400"><?php echo e(translate('Seller Guarantees')); ?></div>
                    </div>
                    <div class="col-10">
                        <?php if($detailedProduct->user->shop->verification_status == 1): ?>
                            <span class="text-success fs-13 fw-700"><?php echo e(translate('Verified seller')); ?></span>
                        <?php else: ?>
                            <span class="text-danger fs-13 fw-700"><?php echo e(translate('Non verified seller')); ?></span>
                        <?php endif; ?>
                    </div>
                </div>
            <?php endif; ?>
    ...
    <div class="row no-gutters mt-4">
        <div class="col-sm-2">
            <div class="text-secondary fs-13 fw-400 mt-2"><?php echo e(translate('Share')); ?></div>
        </div>
        <div class="col-sm-10">
...
<?php /**PATH /home/u536896586/domains/axvero.in/public_html/resources/views/frontend/product_details/details.blade.php ENDPATH**/ ?>