...
<?php $__env->startSection('content'); ?>
    <section class="mb-5" style="margin-top: 2rem;">
        <div class="container">
            <h1 class="fw-700 fs-20 fs-md-24 text-dark"><?php echo e(translate('Best Selling Products')); ?></h1>
            <!-- Products Section -->
            <div class="px-3">
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u536896586/domains/axvero.in/public_html/resources/views/frontend/best_selling.blade.php ENDPATH**/ ?>