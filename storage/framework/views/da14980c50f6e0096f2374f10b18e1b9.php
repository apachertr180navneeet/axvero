<div class="aiz-category-menu bg-white rounded-0 border-top" id="category-sidebar" style="width:270px;">
    <ul class="list-unstyled categories no-scrollbar mb-0 text-left">
        ...
        <?php
            ...
            $categories = get_level_zero_categories()
                            ->where('listing_for', $listing_for)
                            ->take(10);
        ?>
...
</div><?php /**PATH /home/u536896586/domains/axvero.in/public_html/resources/views/frontend/thecore/partials/category_menu.blade.php ENDPATH**/ ?>