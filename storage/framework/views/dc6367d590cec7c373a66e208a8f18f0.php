            ...
            <div class="px-sm-3 ">
                <div class="aiz-carousel sm-gutters-16 arrow-none" data-items="6" data-xl-items="5" data-lg-items="4"  data-md-items="3" data-sm-items="2.5" data-xs-items="2.5" data-arrows='true' data-infinite='false'>
                    ...
                    <div class="carousel-box position-relative px-0 has-transition hov-animate-outline border-right border-top border-bottom <?php if($key == 0): ?> border-left <?php endif; ?>">
                        <div class="px-3">
                            <?php echo $__env->make('frontend.'.get_setting('homepage_select', 'classic').'.partials.product_box_1',['product' => $product], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                    </div>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\axvero\ecom\resources\views/frontend/classic/partials/featured_products_section.blade.php ENDPATH**/ ?>