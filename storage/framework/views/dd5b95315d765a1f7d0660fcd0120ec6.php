...
<?php $lang = get_system_language()?->code ?? 'en'; ?>
<!-- Sliders -->
<div class="home-banner-area mb-3">
    <div class="container">
        <div class="d-flex flex-wrap position-relative">
            <div class="position-static d-none d-xl-block">
                <?php echo $__env->make('frontend.' . get_setting('homepage_select', 'classic') . '.partials.category_menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
                            ...
                            <a href="<?php echo e($product_url); ?>"
                                ...
                                <div class="d-block h-100 position-relative image-hover-effect">
                                    <img class="lazyload h-60px h-md-100px h-lg-140px mw-100 mx-auto has-transition product-main-image"
                                        src="<?php echo e(get_image($flash_deal_product->product->thumbnail)); ?>"
                                    ...
                                    <img class="lazyload h-60px h-md-100px h-lg-140px w-100 mx-auto has-transition product-hover-image position-absolute"
                                        src="<?php echo e(get_first_product_image($flash_deal_product->product->thumbnail, $flash_deal_product->product->photos)); ?>"
                                        alt="<?php echo e($flash_deal_product->product->getTranslation('name')); ?>"
                                        onerror="this.onerror=null;this.src='<?php echo e(static_asset('assets/img/placeholder.jpg')); ?>';">
                                </div>
                                <!-- Price -->
                    ...
                    <div class="d-sm-flex text-center text-sm-left h-100 ">
                        ...
                        <div class="px-2 px-lg-4 flex-grow-1">
                            ...
                            <div class="category-children-container">
                                <?php $__currentLoopData = $category->childrenCategories->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child_category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <p class="mb-0 mt-2">
        ...
        <div class="row py-3 py-md-5">
         ...
         <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                    ...
                    <div class="col-10 d-flex flex-column justify-content-center text-left">
                        <div class="ml-lg-3">
                            <h5 class="fs-20 fs-md-36 fw-400 text-white mb-3"><?php echo e(translate(get_setting('cupon_title'))); ?></h5>
                            <h5 class="fs-15 fs-md-20 fw-400 text-gray mb-3"><?php echo e(translate(get_setting('cupon_subtitle'))); ?></h5>
...
<section class="mb-2 mb-md-3 mt-3 mt-md-3">
    <div class="container">
                    ...
                    <div class="aiz-card-box p-2 has-transition bg-white">
                        <div class="row hov-scale-img">
                            ...
                            <div class="col">
                                ...
                                <span
                                    class="badge badge-inline badge-soft-danger fs-13 fw-700 p-3 text-danger border-radius-20px"><?php echo e(translate('Used')); ?></span>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
        ...
        <div class="bg-white d-sm-none ">
            <div class="aiz-carousel <?php if(count($classified_products) <= 8): ?> arrow-inactive-none arrow-x-0 <?php endif; ?>"
                    ...
                    <div class="d-flex flex-row align-items-start p-2">
                        ...
                        <div class="flex-grow-1">
                            <h3 class="fw-400 fs-13 text-dark text-truncate-1 lh-1-4 mb-1">
                                <a href="<?php echo e(route('customer.product', $classified_product->slug)); ?>"
                                    class="text-reset hov-text-primary"><?php echo e($classified_product->getTranslation('name')); ?></a>
                            </h3>
                            <div class="fs-12 text-muted mb-1">
                                <?php echo e($classified_product->user ? $classified_product->user->name : ''); ?>

                            </div>
                            <div class="fw-700 text-primary fs-13 mb-1">
                                <?php echo e(single_price($classified_product->unit_price)); ?>

                            </div>
                            <div>
                                <?php if($classified_product->conditon == 'new'): ?>
                                <span
                                    class="badge-sm badge-soft-info fs-11 fw-600 px-2 py-1 text-info rounded-pill"><?php echo e(translate('New')); ?></span>
                                <?php elseif($classified_product->conditon == 'used'): ?>
                                <span
                                    class="badge-sm badge-soft-danger fs-11 fw-600 px-2 py-1 text-danger rounded-pill"><?php echo e(translate('Used')); ?></span>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
                ...
                <div class="position-relative px-3 pt-3 pt-md-4 pb-1 pb-md-4">
                    ...
                    <div class="rating rating-mr-2 text-dark mb-3">
                        ...
                        <span class="opacity-60 fs-14 d-block d-sm-inline">
                            (<?php echo e($seller->num_of_reviews); ?> <?php echo e(translate('Reviews')); ?>)
                        </span>
                    </div>
        ...
        <div class="bg-white px-sm-3 px-0">
            ...
            <div class="d-sm-none aiz-carousel arrow-x-0 arrow-inactive-none" data-items="5" data-xxl-items="5"
                ...
                <div class="carousel-box text-center border hov-scale-img has-transition hov-shadow-out z-1">
                    <a href="<?php echo e(route('products.brand', $brand->slug)); ?>" class="d-block p-2 p-sm-3">
                        <img src="<?php echo e($brand->logo != null ? uploaded_asset($brand->logo) : static_asset('assets/img/placeholder.jpg')); ?>"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\axvero\ecom\resources\views/frontend/classic/index.blade.php ENDPATH**/ ?>