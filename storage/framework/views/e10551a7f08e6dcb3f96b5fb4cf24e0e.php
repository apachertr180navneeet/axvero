...
<script>
    const PRODUCT_LIMIT = <?php echo e($productLimit); ?>;
</script>
<script>
...
$(document).on('change', '#bulkBuyerToggle', function () {
    ...
    if (!confirm(message)) {
     ...
     $.ajax({
        url: "<?php echo e(route('cart.update.bulk-buyer')); ?>",
        type: "POST",
        data: {
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u536896586/domains/axvero.in/public_html/resources/views/frontend/view_cart.blade.php ENDPATH**/ ?>