                                                ...
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <th style="line-height:0pt; padding:0; margin:0; font-weight:normal;">
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    <td style="line-height:0pt; text-align:left;"><img src="<?php echo e(uploaded_asset($logo)); ?>" width="" height="26" border="0" alt="" /></td>
                                                                </tr>
                                                            </table>
                                                        </th>
                                                            ...
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    <td style="color:#000000; font-family:'Public Sans', sans-serif; font-size:14px; line-height:16px; text-align:right;">
                                                                        <a href="<?php echo e(env('APP_URL')); ?>" target="_blank" style="color:#000001; text-decoration:none; font-weight: 500">
                                                                            <span  style="color:#000001; text-decoration:none;"><?php echo e(env('APP_NAME')); ?></span>
                                                                        </a>
                                                                    </td>
                                                                </tr>
                                                            </table>
...
</table><?php /**PATH /home/u536896586/domains/axvero.in/public_html/resources/views/emails/index.blade.php ENDPATH**/ ?>